...
![](https://minios.strongsickcat.com/dinghuang-blog-picture/common/WechatIMG758.png)


运行我们``test.gradle``中自己写的task，``gradle jacocoReport``，会生成单元测试覆盖报告在路径``build\reports\jacoco\index.html``，如图所示

![](https://minios.strongsickcat.com/dinghuang-blog-picture/common/WechatIMG759.png)