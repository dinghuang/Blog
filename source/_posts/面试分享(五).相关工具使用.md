...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/0924-6.jpg)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/0924-7.jpg)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/0924-8.jpg)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/0924-9.jpg)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/0924-10.jpg)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/0924-11.jpg)

增加一个consumer(consumer2)后，其中一个consumer（consumer1）可消费2个partition的数据，另外一个consumer(consumer2)可消费另外一个partition的数据。

![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/0924-12.jpg)

再增加一个consumer(consumer3)后，每个consumer可消费一个partition的数据。consumer1消费partition0，consumer2消费partition1，consumer3消费partition2
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/0924-13.jpg)

再增加一个consumer（consumer4）后，其中3个consumer可分别消费一个partition的数据，另外一个consumer（consumer4）不能消费topic1任何数据。
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/0924-14.jpg)

此时关闭consumer1，剩下的consumer可分别消费一个partition的数据。
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/0924-15.jpg)

接着关闭consumer2，剩下的consumer3可消费2个partition，consumer4可消费1个partition。
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/0924-16.jpg)

再关闭consumer3，剩下的consumer4可同时消费topic1的3个partition。
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/0924-17.jpg)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/0924-18.jpg)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/0924-19.jpg)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/0924-20.jpg)

正如我们所预期的那样，随着消息长度的增加，每秒钟所能发送的消息的数量逐渐减小。但是如果看每秒钟发送的消息的总大小，它会随着消息长度的增加而增加，如下图所示。
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/0924-21.jpg)
