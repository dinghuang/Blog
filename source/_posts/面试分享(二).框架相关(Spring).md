...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/c456f949-7b9c-34db-ad1a-ca3141219b6d.jpg)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/1656058-20190611152652742-1944751292.png)

## 如何理解Spring中的AOP 和 IOC，以及DI，读过Spring源码没有？
### AOP
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/12942196-ccb87f486fddc550.png)
...
Spring DI运行时序图
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/1624288-20190628135317957-1069467007.png)
...
### Hystrix设计模式
设计详解（命令模式）
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/20180719101351962.png)
流程图
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/hystrix-command-flow-chart.png)
流程说明
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/20180719101939418.png)

### 线程和线程池
客户端（第三方，网络调用等）依赖和请求线程运行在不同的线程上，这个将他们从调用线程隔离开来，这样调用者就可以从一个耗时太长的依赖中隔离。如下图所示，也可以为不同的请求开启不同的线程池，彼此之间不相互干扰。

![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/circuit-breaker-1280.png)
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/isolation-options-12801.png)
（注：上图右边表示的是信号量模式）
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/2018071910300525.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/12540413-62c81551958254dc.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/12540413-a229d45b54a02423.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/584866-20170519183209291-1684980050.png)
其中prepare阶段的作用，如下图所示：
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/584866-20170519173152510-2089061877.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/584866-20170522174941023-1628898506.png)
如果leader稳定，不需要prepare和promise步骤，如下图（图中Proposer就是一个Leader）：
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/584866-20170522175104867-87240999.png)
...
　　![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/584866-20170523192819976-189903080.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/WechatIMG265.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/WechatIMG266.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/WechatIMG267.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/WechatIMG268.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/WechatIMG269.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/WechatIMG270.png)
TCC 分布式事务模型包括三部分：
