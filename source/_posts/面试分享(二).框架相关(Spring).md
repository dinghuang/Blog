...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/ead09fcb-3c6c-3740-9e36-6de33fd65cca.jpg)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/c4143d16-02e2-3d7b-9734-4d19a9a984dd.jpg)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/24095923-75cd-363b-bc2f-9fbc603c341f.jpg)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/c456f949-7b9c-34db-ad1a-ca3141219b6d.jpg)

以上 5 个组件基本代表了 ioc 容器的一个最基本组成，而组件的组合是放在 ApplicationContext 的实现这一层来完成。


![image](https://minios.strongsickcat.com/dinghuang-blog-picture/d9a0e8c8-29d6-36a3-888e-e22c2d1bb44f.jpg)
...
### 容器初始化过程
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/370101b5-b3d1-3b79-b9b2-3bba91d092d7.jpg)
...
```
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/2187e288-5c0b-313b-8053-82992267fab6.jpg)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/2beb44aa-4b38-3d87-a444-308d8f380e87.jpg)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/a2d7e37b-e394-3f90-bf20-7f480db1dc5d.jpg)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/1486692b-7ba3-3d1d-a6f6-1c70aa45a21e.jpg)
...
```
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/WechatIMG992.jpeg)
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/WechatIMG993.png)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/1656058-20190611152652742-1944751292.png)

## 如何理解Spring中的AOP 和 IOC，以及DI，读过Spring源码没有？
### AOP
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/12942196-ccb87f486fddc550.png)
...
Spring DI运行时序图
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/1624288-20190628135317957-1069467007.png)
...
### Hystrix设计模式
设计详解（命令模式）
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/20180719101351962.png)
流程图
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/hystrix-command-flow-chart.png)
流程说明
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/20180719101939418.png)

### 线程和线程池
客户端（第三方，网络调用等）依赖和请求线程运行在不同的线程上，这个将他们从调用线程隔离开来，这样调用者就可以从一个耗时太长的依赖中隔离。如下图所示，也可以为不同的请求开启不同的线程池，彼此之间不相互干扰。

![image](https://minios.strongsickcat.com/dinghuang-blog-picture/circuit-breaker-1280.png)
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/isolation-options-12801.png)
（注：上图右边表示的是信号量模式）
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/2018071910300525.png)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/12540413-62c81551958254dc.png)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/12540413-a229d45b54a02423.png)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/584866-20170519183209291-1684980050.png)
其中prepare阶段的作用，如下图所示：
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/584866-20170519173152510-2089061877.png)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/584866-20170522174941023-1628898506.png)
如果leader稳定，不需要prepare和promise步骤，如下图（图中Proposer就是一个Leader）：
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/584866-20170522175104867-87240999.png)
...
　　![image](https://minios.strongsickcat.com/dinghuang-blog-picture/584866-20170523192819976-189903080.png)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/WechatIMG265.png)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/WechatIMG266.png)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/WechatIMG267.png)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/WechatIMG268.png)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/WechatIMG269.png)
...
![image](https://minios.strongsickcat.com/dinghuang-blog-picture/WechatIMG270.png)
TCC 分布式事务模型包括三部分：
