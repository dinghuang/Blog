...
```
object.out文件如下
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20180407130515728.png)
...
序列化图示：
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20180408163613978.jpeg)
反序列化图示：
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20180408163634701.jpeg)
...
节点时构成同步队列的基础，AQS拥有首节点和尾节点，没有成功获取到同步状态的节点会加入到同步队列的尾部，同步队列的结构如下图所示
 ![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20180509004159305.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20180509005738767.png)
- 将节点设置为首节点：同步队列遵循FIFO，首节点是获取同步状态成功的节点，首节点的线程在释放同步状态时，会唤醒后继节点，而后继节点将会在获取同步状态成功时将自己设置为首节点。
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20180509005820225.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/WechatIMG252.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/WechatIMG253.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/WechatIMG254.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/WechatIMG255.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1182497-20170616192740650-1039521219.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1489669-20181016185255493-478123409.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1489669-20181016192344776-1456921556.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1489669-20181016192808209-1144011671.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1489669-20181016193120797-694786115.png)
...
现在的虚拟机垃圾收集大多采用这种方式，它根据对象的生存周期，将堆分为新生代(Young)和老年代(Tenure)。在新生代中，由于对象生存期短，每次回收都会有大量对象死去，那么这时就采用复制算法。老年代里的对象存活率较高，没有额外的空间进行分配担保，所以可以使用标记-整理 或者 标记-清除。
 ...
 ![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1489669-20181016194033050-1554933093.png)
 
 当系统创建一个对象的时候，总是在Eden区操作，当这个区满了，那么就会触发一次YoungGC，也就是年轻代的垃圾回收。一般来说这时候不是所有的对象都没用了，所以就会把还能用的对象复制到From区。 

 ![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1489669-20181016194136097-936358657.png)
 
 这样整个Eden区就被清理干净了，可以继续创建新的对象，当Eden区再次被用完，就再触发一次YoungGC，然后呢，注意，这个时候跟刚才稍稍有点区别。这次触发YoungGC后，会将Eden区与From区还在被使用的对象复制到To区， 
 
 ![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1489669-20181016194207606-298577682.png)
 
 再下一次YoungGC的时候，则是将Eden区与To区中的还在被使用的对象复制到From区。
 
 ![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1489669-20181016194236007-1428408352.png)
 
 经过若干次YoungGC后，有些对象在From与To之间来回游荡，这时候From区与To区亮出了底线（阈值），这些家伙要是到现在还没挂掉，对不起，一起滚到（复制）老年代吧。 
 
 ![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1489669-20181016194302974-1844734331.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1489669-20181016195304547-1979156977.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1489669-20181016195337336-1777000798.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1489669-20181016195404250-2142909553.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1489669-20181016195447698-597277595.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1489669-20181016195748885-635394429.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1489669-20181016195818822-811200159.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/1489669-20181016201012220-784045144.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20190422101506890.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/2019042210300768.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20190422104629928.png)
- 接着，线程2会将自己放入AQS中的一个等待队列，因为自己尝试加锁失败了，此时就要将自己放入队列中来等待，等待线程1释放锁之后，自己就可以重新尝试加锁了

![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20190422104805138.png)

- 接着，线程1在执行完自己的业务逻辑代码之后，就会释放锁！他释放锁的过程非常的简单，就是将AQS内的state变量的值递减1，如果state值为0，则彻底释放锁，会将“加锁线程”变量也设置为null！
整个过程，参见下图：
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20190422104853687.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20190422105125131.png)
...
分析OOM的工具推荐使用MAT，[下载地址](https://projects.eclipse.org/projects/tools.mat)，在配置好Java环境的电脑中，直接打开即可，不需要安装，然后通过MAT打开已经生成的OOM文件oom.out，出现如下提示，选择“Leak Suspects Report”执行内存泄漏检查分析：
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/2018091318062115.png)

点击Finish按钮后，MAT会将可疑的内存泄漏的对象都展现出来：

![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20180913181010465.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20180913182035623.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20190401203922492.png)

其中的``pid``是你关注的``java``进程号，可根据``jps``查询。
``-gcutil``是关心的指标，更多详尽信息请参看官方文档。

- ``options``
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20190401203945843.png)

- ``description``(后面也有详尽的字段说明)
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20190401204007393.png)

- ``jstat -option pid peroid times``(周期监控)
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20190401204040778.png)
...
### jconsole
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20190401204425551.png)
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20190401204446766.png)

## 假设有下图所示的一个Full GC 的图，纵向是内存使用情况，横向是时间，你如何排查这个Full GC 的问题，怎么去解决你说出来的这些问题？

 ![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/WechatIMG232.jpeg)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20170411171801782.png)

查看char[]类型数据，发现几乎全是sql语句。
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20170411171833819.png)
 
接下来查看char[]的引用情况：
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20170411171909424.png)
...
### 其他
 ...
 ![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20180713093200563.png)
...
#### 线性表
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626162657335-766064343.png)
...
#### 哈希表
解释一:
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626163141411-168462787.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626163257503-1905188703.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626163747154-56316670.png)
如上图中:
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626163840863-763737563.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626163919941-1822754534.png)
2.对 r 的左儿子的右子树进行一次插入（LR）
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626164125162-953176289.png)
3.对 r 的右儿子的左子树进行一次插入（RL）
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626164216908-1934757880.png)
4.对 r 的右儿子的右子树进行一次插入（RR）
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626164301670-331612976.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626164550259-105010205.jpg)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626164758729-301674609.jpg)

![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626164805332-951627135.jpg)
...
a. 叶子节点；(直接删除即可)
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626164943173-2121042227.jpg)
b. 仅有左或右子树的节点；（上移子树即可）
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626165004166-642012957.jpg)　
c. 左右子树都有的节点。( 用删除节点的直接前驱或者直接后继来替换当前节点，调整直接前驱或者直接后继的位置)
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626165016051-1231487357.jpg)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626165124764-1792079285.jpg)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626165221571-2091816346.jpg)
  ...
  ![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626165301994-226570115.jpg)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626165338024-2048461274.jpg)
...
比如``List<string>``就直接使用string对象作为List的元素，而避免使用object对象带来的封箱、拆箱操作，从而提高程序性能。
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/588112-20180626171656243-895639630.jpg)
...
HashMap实际上是一个“链表散列”的数据结构，即数组和链表的结合体。底层是个数组，数组上存储的数据是``Entry<K,V>``类型的链表结构对象。
...
#### LinkeHashMap
LinkedHashMap继承自HashMap，实现了``Map<K,V>``接口。其内部还维护了一个双向链表，在每次插入数据，或者访问、修改数据时，会增加节点、或调整链表的节点顺序。以决定迭代时输出的顺序。
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/17987782-450f4a923f40b9f4.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20180619193100237.jpeg)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20180619200443603.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/20180619194820999.png)
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/WechatIMG256.png)
...
1. 操作员 B 完成了操作，也将版本号加一（ version=2 ）试图向数据库提交数据（ balance=$80 ），但此时比对数据库记录版本时发现，操作员 B 提交的数据版本号为 2 ，数据库记录当前版本也为 2 ，不满足 “ 提交版本必须大于记录当前版本才能执行更新 “ 的乐观锁策略，因此，操作员 B 的提交被驳回。
...
1. 又来了一个任务（B），且核心2个线程还没有忙完，OK，接下来首先尝试1中描述，但是由于使用的SynchronousQueue，所以一定无法加入进去。
1. 此时便满足了上面提到的“如果无法将请求加入队列，则创建新的线程，除非创建此线程超出maximumPoolSize，在这种情况下，任务将被拒绝。”，所以必然会新建一个线程来运行这个任务。
1. 暂时还可以，但是如果这三个任务都还没完成，连续来了两个任务，第一个添加入queue中，后一个呢？queue中无法插入，而线程数达到了maximumPoolSize，所以只好执行异常策略了。
...
![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/9bc4cb9fgy1g0and9vxv5j225607ut9t.jpg)
...
- 命令模式（Command Pattern）是一种数据驱动的设计模式，它属于行为型模式。请求以命令的形式包裹在对象中，并传给调用对象。调用对象寻找可以处理该命令的合适的对象，并把该命令传给相应的对象，该对象执行命令。
    ...
    ![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/command_pattern_uml_diagram.jpg)
    ```
...
- 观察者模式，当对象间存在一对多关系时，则使用观察者模式（Observer Pattern）。比如，当一个对象被修改时，则会自动通知它的依赖对象。观察者模式属于行为型模式。
    ...
    ![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/observer_pattern_uml_diagram.jpg)
    ```
    import java.util.ArrayList;
    import java.util.List;
...
- 策略模式:在策略模式（Strategy Pattern）中，一个类的行为或其算法可以在运行时更改。这种类型的设计模式属于行为型模式。在策略模式中，我们创建表示各种策略的对象和一个行为随着策略对象改变而改变的 context 对象。策略对象改变 context 对象的执行算法。
    ...
    ![image](http://www.strongsickcat.com:7014/file/dinghuang-blog-picture/strategy_pattern_uml_diagram.jpg)
    ```
