...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/1489669-20181016195447698-597277595.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/20170411171801782.png)

查看char[]类型数据，发现几乎全是sql语句。
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/20170411171833819.png)
 
接下来查看char[]的引用情况：
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/20170411171909424.png)
...
### 其他
 ...
 ![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/20180713093200563.png)
...
#### 线性表
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626162657335-766064343.png)
...
#### 哈希表
解释一:
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626163141411-168462787.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626163257503-1905188703.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626163747154-56316670.png)
如上图中:
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626163840863-763737563.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626163919941-1822754534.png)
2.对 r 的左儿子的右子树进行一次插入（LR）
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626164125162-953176289.png)
3.对 r 的右儿子的左子树进行一次插入（RL）
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626164216908-1934757880.png)
4.对 r 的右儿子的右子树进行一次插入（RR）
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626164301670-331612976.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626164550259-105010205.jpg)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626164758729-301674609.jpg)

![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626164805332-951627135.jpg)
...
a. 叶子节点；(直接删除即可)
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626164943173-2121042227.jpg)
b. 仅有左或右子树的节点；（上移子树即可）
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626165004166-642012957.jpg)　
c. 左右子树都有的节点。( 用删除节点的直接前驱或者直接后继来替换当前节点，调整直接前驱或者直接后继的位置)
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626165016051-1231487357.jpg)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626165124764-1792079285.jpg)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626165221571-2091816346.jpg)
  ...
  ![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626165301994-226570115.jpg)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626165338024-2048461274.jpg)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/588112-20180626171656243-895639630.jpg)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/17987782-450f4a923f40b9f4.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/20180619193100237.jpeg)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/20180619200443603.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/20180619194820999.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/WechatIMG256.png)
...
![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/9bc4cb9fgy1g0and9vxv5j225607ut9t.jpg)
...
- 命令模式（Command Pattern）是一种数据驱动的设计模式，它属于行为型模式。请求以命令的形式包裹在对象中，并传给调用对象。调用对象寻找可以处理该命令的合适的对象，并把该命令传给相应的对象，该对象执行命令。
    ...
    ![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/command_pattern_uml_diagram.jpg)
    ```
...
- 观察者模式，当对象间存在一对多关系时，则使用观察者模式（Observer Pattern）。比如，当一个对象被修改时，则会自动通知它的依赖对象。观察者模式属于行为型模式。
    ...
    ![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/observer_pattern_uml_diagram.jpg)
    ```
    import java.util.ArrayList;
    import java.util.List;
...
- 策略模式:在策略模式（Strategy Pattern）中，一个类的行为或其算法可以在运行时更改。这种类型的设计模式属于行为型模式。在策略模式中，我们创建表示各种策略的对象和一个行为随着策略对象改变而改变的 context 对象。策略对象改变 context 对象的执行算法。
    ...
    ![image](https://minioapi.frp.strongsickcat.com/file/dinghuang-blog-picture/strategy_pattern_uml_diagram.jpg)
    ```
